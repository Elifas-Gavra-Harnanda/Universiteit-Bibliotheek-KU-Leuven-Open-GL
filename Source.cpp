...
void atap_tengah() {
    ...
    glBegin(GL_POLYGON);
    glColor3f(0.980f, 0.922f, 0.843f);
    glVertex3f(7, 20, 18);
    glVertex3f(7, 48, 18);
    glVertex3f(0, 48, 18);
    glVertex3f(0, 20, 18);
...
void cerobong1() {
    ...
    glVertex3f(-28.49, 37.52, 7.84); //kiri bawah
    glVertex3f(-25.49, 37.52, 7.84); //kiri atas
    glVertex3f(-25.49, 43.52, 7.84); //kanan atas
    glVertex3f(-28.49, 43.452, 7.84); //kanan bawah
    glEnd();
    //belakang
    glBegin(GL_POLYGON);
    glColor3f(0.961, 0.871, 0.702);
...
void cerobong2() {
    ...
    glBegin(GL_POLYGON);
    glColor3f(0.545, 0.271, 0.075);
    glVertex3f(26.89, 37.52, 7.84); //kiri bawah
    glVertex3f(23.89, 37.52, 7.84); //kiri atas
    glVertex3f(23.89, 43.52, 7.84); //kanan atas
    glVertex3f(26.89, 43.452, 7.84); //kanan bawah
    glEnd();
    //belakang
    glBegin(GL_POLYGON);
    glColor3f(0.961, 0.871, 0.702);
...
void pagaratap(float x, float y, float z)
{
    glBegin(GL_POLYGON);
    glColor3f(1.000, 0.871, 0.678);
    glVertex3f(-14 - x, 20 + y, 20 + z); //kiri bawah
    glVertex3f(-14 - x, 27 + y, 20 + z); //kiri atas
    glVertex3f(-14.5 - x, 27 + y, 20 + z); //kanan atas
    glVertex3f(-14.5 - x, 20 + y, 20 + z); //kanan bawah
    glEnd();
}

void pagaratap1(float x, float y, float z)
{
    glBegin(GL_POLYGON);
    glColor3f(1.000, 0.871, 0.678);
    glVertex3f(14 + x, 20 + y, 20 + z); //kiri bawah
...
void pagaratapz()
{
    glBegin(GL_POLYGON);
    glColor3f(1.000, 0.871, 0.678);
    glVertex3f(-30 , 19 , 20 ); //kiri bawah
    glVertex3f(-30 , 27 , 20 ); //kiri atas
    glVertex3f(-42 , 27 , 20 ); //kanan atas
    glVertex3f(-42 , 19 , 20 ); //kanan bawah
    glEnd();
}
...
void pagaratapzy()
{
    glBegin(GL_POLYGON);
    glColor3f(1.000, 0.871, 0.678);
    glVertex3f(-57, 19, 20); //kiri bawah
    glVertex3f(-57, 27, 20); //kiri atas
    glVertex3f(-60, 27, 20); //kanan atas
    glVertex3f(-60, 19, 20); //kanan bawah
    glEnd();
}
...
void pagaratapa()
{
    glBegin(GL_POLYGON);
    glColor3f(0.871, 0.722, 0.529);
    glVertex3f(60, 18, 20.4); //kiri bawah
    glVertex3f(60, 19.5, 20.4); //kiri atas
    glVertex3f(-60, 19.5, 20.4); //kanan atas
    glVertex3f(-60, 18, 20.4); //kanan bawah
    glEnd();

    glBegin(GL_POLYGON);
    glColor3f(0.871, 0.722, 0.529);
    glVertex3f(-60.4, 19.5, 20.4); //kanan atas
    glVertex3f(-60.4, 18, 20.4); //kanan bawah
    glVertex3f(-60.4, 18, -10.4); //kanan bawah
    glVertex3f(-60.4, 19.5, -10.4); //kanan atas
    glEnd();
    ...
    glBegin(GL_POLYGON);
    glColor3f(0.871, 0.722, 0.529);
    glVertex3f(60, 18, -10.4); //kiri bawah
    glVertex3f(60, 19.5, -10.4); //kiri atas
    glVertex3f(40, 19.5, -10.4); //kanan atas
    glVertex3f(40, 18, -10.4); //kanan bawah
    glEnd();
...
void pagaratapb()
{
    glBegin(GL_POLYGON);
    glColor3f(0.871, 0.722, 0.529);
    glVertex3f(60, 18, -80.4); //kiri bawah
    glVertex3f(60, 19.5, -80.4); //kiri atas
    glVertex3f(-60, 19.5, -80.4); //kanan atas
    glVertex3f(-60, 18, -80.4); //kanan bawah
    glEnd();

    glBegin(GL_POLYGON);
    glColor3f(0.871, 0.722, 0.529);
    glVertex3f(-60.4, 19.5, -80.4); //kanan atas
    glVertex3f(-60.4, 18, -80.4); //kanan bawah
    glVertex3f(-60.4, 18, -49.8); //kanan bawah
    glVertex3f(-60.4, 19.5, -49.8); //kanan atas
    glEnd();
    ...
    glBegin(GL_POLYGON);
    glColor3f(0.871, 0.722, 0.529);
    glVertex3f(60, 18, -49.8); //kiri bawah
    glVertex3f(60, 19.5, -49.8); //kiri atas
    glVertex3f(40, 19.5, -49.8); //kanan atas
    glVertex3f(40, 18, -49.8); //kanan bawah
    glEnd();
...
void pagaratap3(float x, float y, float z)
{
    glBegin(GL_POLYGON);
    glColor3f(1.000, 0.871, 0.678);
    glVertex3f(-15.95 - x, 20 + y, 20 + z); //kiri bawah
    glVertex3f(-15.95 - x, 29 + y, 20 + z); //kiri atas
    glVertex3f(-16.95 - x, 29 + y, 20 + z); //kanan atas
    glVertex3f(-16.95 - x, 20 + y, 20 + z); //kanan bawah
    glEnd();
}


void pagaratap4(float x, float y, float z)
{
    glBegin(GL_POLYGON);
    glColor3f(1.000, 0.871, 0.678);
    glVertex3f(15.95 + x, 20 + y, 20 + z); //kiri bawah
...
void pagaratap5()
{
    glBegin(GL_POLYGON);
    glColor3f(1.000, 0.871, 0.678);
    glVertex3f(-13 , 26 , 20 ); //kiri bawah
    glVertex3f(-13 , 27 , 20 ); //kiri atas
    glVertex3f(-59 , 27 , 20 ); //kanan atas
    glVertex3f(-59 , 26 , 20 ); //kanan bawah
    glEnd();
}
